...
```bash
ls ~/.simple-secrets
# If directory exists, you're NOT testing first-run!
# Either: rm -rf ~/.simple-secrets (for clean testing)
# Or: Note that you're testing existing installation behavior
# DON'T PANIC when you don't see first-run setup if installation exists!
```
